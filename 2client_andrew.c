...

{
    ...
    //locking all mutexes initially
    pthread_mutex_lock(&mutex_read);
    pthread_mutex_lock(&mutex_write);

    // creation of threads w corr. funcs
    pthread_create(&thread_read, &attr, read_server, NULL);
    pthread_create(&thread_write, &attr, write_server, NULL);
